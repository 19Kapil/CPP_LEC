// overloading the function when function are in base 
#include<iostream>
...
d1.display('a'); 
//error: function will behidden after overriding

d1.display(5);
//error: function will be hidden after overriding 

d1.base::display('a'); 
//calls base class display () with char argumentB

d1.base::display (5); 
//calls base class display with int argument 
